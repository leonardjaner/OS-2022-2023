...
int main(int argc, char *argv[])
{
    ...
    /* Wait for thread2 */
    result = pthread_join(handle_thread_id2, NULL);
    if (result > 0) {
        fprintf(stderr, "Joining thread handle_thread error: errno = %d\n", errno);
        exit(1);
    }
